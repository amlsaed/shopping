...
let getId =JSON.parse(localStorage.getItem('productId'));
let product = products.find((item)=>item.id ==getId);

function DrawDetail(products){
              ...
              <div class = "product-imgs">
                <div class = "img-display">
                  <div class = "img-showcase">
                    <img src = "${product.image}" alt = "shoe image" class="first">
    ...
    document.querySelector(".productDetail").innerHTML=productDtl;
}
DrawDetail(product)
